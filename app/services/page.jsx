...
export default function ServicesPage() {
  ...
  return (
    <>
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid md:grid-cols-2 gap-6 sm:gap-12">
            {/* Waterproofing */}
            <div className="bg-slate-50 rounded-xl p-5 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4">Waterproofing</h3>
              <p className="text-slate-600 text-xs sm:text-base mb-6">
            ...
            <div className="bg-slate-50 rounded-xl p-5 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4">Decorative Epoxy / PU Flooring</h3>
              <p className="text-slate-600 text-xs sm:text-base mb-6">
            ...
            {/* Consultancy */}
            <div className="bg-slate-50 rounded-xl p-5 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4">Consultancy</h3>
              <p className="text-slate-600 text-xs sm:text-base mb-6">
            ...
            <div className="bg-slate-50 rounded-xl p-5 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4">Painting &amp; Protective Coating</h3>
              <p className="text-slate-600 text-xs sm:text-base mb-6">
            ...
            <div className="bg-slate-50 rounded-xl p-5 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4">Structural Strengthening</h3>
              <p className="text-slate-600 text-xs sm:text-base mb-6">
            ...
            <div className="bg-slate-50 rounded-xl p-5 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4">Supply of Construction Chemicals</h3>
              <p className="text-slate-600 text-xs sm:text-base mb-6">
      ...
      <section className="py-12 sm:py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-3 sm:mb-4">Our Process</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 sm:gap-8 text-center text-xs sm:text-sm font-semibold text-slate-800">
            <div className="relative process-step">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-royal-600 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white font-bold text-lg sm:text-xl">1</div>
              Inspection
            </div>

            <div className="relative process-step">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-royal-600 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white font-bold text-lg sm:text-xl">2</div>
              Recommendation
            </div>

            <div className="relative process-step">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-royal-600 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white font-bold text-lg sm:text-xl">3</div>
              Application
            </div>

            <div className="relative process-step">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-royal-600 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white font-bold text-lg sm:text-xl">4</div>
              Quality Check
            </div>

            <div className="relative process-step col-span-2 sm:col-span-1">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-royal-600 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white font-bold text-lg sm:text-xl">5</div>
              Completion
            </div>
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="py-12 sm:py-16 bg-gradient-to-r from-royal-700 to-royal-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-3 sm:mb-4">
            Need Professional Application Services?
          </h2>
          <p className="text-royal-200 text-xs sm:text-base mb-6 sm:mb-8 max-w-2xl mx-auto">
            Our trained applicators ensure proper installation for optimal performance.
          </p>
          <Link
            href="/contact"
            className="bg-white text-royal-700 px-6 sm:px-8 py-3.5 sm:py-4 rounded-lg font-semibold hover:bg-royal-50 transition-all inline-block w-full sm:w-auto text-center text-sm"
          >
            Request Site Visit
          </Link>
        </div>
